...
INSERT INTO `categories` (`seq`, `category_name`, `order_number`, `created_id`, `created_datetime`, `modified_id`, `modified_datetime`) VALUES
(1, '자동차', 0, 'hshan', '2022-11-13', NULL, NULL),
(2, '여행', 1, 'hshan', '2022-11-13', NULL, NULL);
